...
**Row count:** 5-20 districts (depends on scale)
...
**Row count:** 100-600 nodes (depends on scale)
...
**Row count:** 500-6000 objects (depends on scale)
...
**Row count:** 750-9000 sensors (depends on scale)
...
**Row count:** 300-3600 meters (depends on scale)
...
**Row count:** Millions of records (depends on scale and period)
...
**Row count:** 75-1200 events (depends on scale)
...
**Row count:** 10,000-160,000 requests (depends on scale)
...
**Row count:** 50,000-800,000 trips (depends on scale)
