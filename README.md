...
- [ ] Исправить баг BUG-001 — Example Questions (ETA: 23.01.2026)
...
- [ ] Изменить генерацию дорог. Генерируется слишком много Highway (ETA: 23.01.2026)

#### Пример заполнения этого блока
- [ ] Добавить поддержку PostgreSQL (план: 21.01.2026)
- [x] ~~Настроить SQL-валидацию (сделано: 21.01.2026)~~
